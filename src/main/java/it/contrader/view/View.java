...
public interface View {
	 ...
	 * funzionamento: generalmente il metodo showResult stamper� su schermo i vari dati che la singola view necessit� di far
	...
	/*
	 * funzionamento : il metodo showOption mostrer� su schermo di volta in volta le varie opzione ( una sorta di menu )
