 ...
 * Essa sara di fatto la prima funzione chiamata dalla JVM, la sua mancanza verra infatti notata dall'interprete che 
 * quindi non permettera l'avvio del programma.
