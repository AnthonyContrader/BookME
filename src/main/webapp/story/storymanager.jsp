...
<br>
	...
	<table>
		...
		<tr>
			...
			<td><a href=StoryServlet?mode=read&update=true&id=<%=u.getId_Storie()%>>Edit</a>
			</td>
...
<form id="floatright" action="StoryServlet?mode=insert" method="post">
  <div class="row">
    ...
    <div class="col-75">
      <input type="text" id="trama" name="Trama" placeholder="inserisci Trama">
    </div>
  </div>
  <div class="row">
    <div class="col-25">
    ...
    <div class="col-75">
      <input type="text" id="id_Categoria" name="id_Categoria" placeholder="inserisci id_Categoria"> 
    </div>
  </div>
<!--   <div class="row"> -->
<!--     <div class="col-25"> -->
